  ...
  return (
    <main className="flex w-full min-h-screen">
      <div className="w-full bg-white p-6 rounded-lg shadow-md max-w-4xl mx-4">
        <h4 className="text-xl font-semibold text-blue-900 mb-4">Question & Answer</h4>

        {/* Header Section */}
        <div className="header flex justify-between items-center mb-8">
          <div className="sort flex gap-4 py-4 items-center">
            <div className="select flex items-center gap-2">
              <span className="sortby text-sm font-medium text-gray-700">Sort by:</span>
              <select 
                name="qa" 
                id="qa" 
        ...
        <div className="text-center w-full px-4">
          <h1 className="text-2xl font-bold mb-6 text-gray-700">Question & Answer</h1>
